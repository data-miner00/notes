...
<template>
  ...
  >
    <article
      class="prose prose-stone dark:prose-invert sm:max-w-[55ch] prose-pre:bg-gray-50 dark:prose-pre:bg-slate-800 dark:prose-pre:text-gray-50 prose-pre:border prose-pre:border-gray-200 dark:prose-pre:border-gray-700 prose-pre:border-solid prose-pre:rounded-lg prose-pre:text-slate-800 prose-headings:text-cyan-600 dark:prose-hr:border-gray-700 dark:prose-li:marker:text-gray-200 dark:prose-blockquote:border-gray-200 prose-headings:scroll-mt-24 dark:prose-tr:border-gray-500 dark:prose-thead:border-gray-400 prose-table:block lg:prose-table:table prose-table:overflow-x-scroll"
    >
