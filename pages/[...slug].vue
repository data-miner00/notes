    ...
    >
      ...
      <div class="flex justify-between gap-4">
        <NuxtLink
          ...
          class="text-xs md:text-base block px-3 py-2 basis-1/2 lg:basis-auto lg:py-1 border border-solid border-gray-200 dark:border-gray-700 rounded hover:text-green-600"
        >
          ← {{ prev.title }}
        </NuxtLink>
