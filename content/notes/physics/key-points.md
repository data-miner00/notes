...
- Displacement, $s$ is the distance travelled in a specific direction
- Speed, $x$ is the distance travelled per unit time, the rate of change of distance
- Velocity, $v$ is the speed of an object in a specific dierction, the rate of change of displacement.
- Acceleration, $a$ is the rate of change in velocity with time
