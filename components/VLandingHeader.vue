...
<template>
  ...
  >
    <nav class="flex items-center" aria-label="primary-navigation">
      ...
      <div class="text-2xl font-bold mr-5 text-white">
        <NuxtLink :to="localePath('index')" class="flex items-center">
          <!-- <img src="/nuxt.svg" alt="Nuxt logo" class="block w-8 h-8" /> -->
          <span class="ml-1 block uppercase tracking-widest">Notes</span>
        </NuxtLink>
      </div>
      <ul class="hidden lg:flex gap-4 font-semibold text-white text-sm">
        <li>
